...
// поля в правом меню
let employerName1 = document.querySelector("#employers_1");
let employerName2 = document.querySelector("#employers_2");
let employerName3 = document.querySelector("#employers_3");
...
console.log(employerName1);
console.log(employerName2);
console.log(employerName3);
